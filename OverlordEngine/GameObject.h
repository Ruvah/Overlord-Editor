...
public:
	...
	void RemoveComponent(BaseComponent* pComp, bool deleteLater = false);
	...
	std::vector<GameObject*> GetAllChildren() { return m_pChildren; }
...
protected:
	...
	std::vector<BaseComponent*> m_pDeleteLater;

	bool m_IsInitialized, m_IsActive, m_IDGiven;
	...
	static UINT m_NextSceneID;
	static vector<GameObject*> m_pAllGameObjects;
};
